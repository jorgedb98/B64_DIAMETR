...
setwd("/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv_cpgs_bmi_MRS/hpdi/")
print("loading files")
...
free_text="./"
print(free_text)
out.file="model_hpdi_cpgs_bmi_mrs"
print(out.file)
...
pheno <- pheno[, c(num_covariates, chr_covariates, "Slide","BMIX","hpdi_mrs")]
print(head(pheno))
print(names(pheno)) 
pheno <- na.omit(pheno)
print(dim(pheno))
...
print("people to analyze")
people<-rownames(mt_val)
print(dim(mt_val))
print(length(people))
