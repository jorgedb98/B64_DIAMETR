...
setwd("/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv_cpgs_bmi_MRS/dashf/")
print("loading files")
...
free_text="./"
print(free_text)
out.file="model_dashf_cpgs_bmi_mrs"
print(out.file)
...
pheno <- pheno[, c(num_covariates, chr_covariates, "Slide","BMIX","dashf_mrs")]
print(head(pheno))
print(names(pheno)) 
pheno <- na.omit(pheno)
print(dim(pheno))
