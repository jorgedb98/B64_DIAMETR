...
res1 = get(load("/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv/hpdi/bacon.RData"))
...
p <- ggplot(don, aes(x=BPcum, y=-log10(P))) +
 ...
 ggsave(plot = p, filename = "~/B64_DIAMETR/Scripts/WHI/sv/hpdi/manhattanplot_bacon.png")  
 save(manh1, file="~/B64_DIAMETR/Scripts/WHI/sv/hpdi/bacon_noxy.RData")
