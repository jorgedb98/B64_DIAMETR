...
#Modelo 1
res1 = get(load("/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv/rmed/bacon.RData"))
...
#Manhattan Plot:
png("/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv/rmed/manhattanplot_bacon.png", 
    height=3600, 
    width=6000, 
    res=600,
    units = "px")
...
abline(h=-log10(0.05/length(cpg)), 
       col="black",
       lty=2)
title(main = "Manhattan plot WHI rmed")
