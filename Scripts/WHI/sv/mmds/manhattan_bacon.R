...
res1 = get(load("/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv/mmds/bacon.RData"))
...
p <- ggplot(don, aes(x=BPcum, y=-log10(P))) +
 ...
 ggsave(plot = p, filename = "~/B64_DIAMETR/Scripts/WHI/sv/mmds/manhattanplot_bacon.png")  
 save(manh1, file="~/B64_DIAMETR/Scripts/WHI/sv/mmds/bacon_noxy.RData")
