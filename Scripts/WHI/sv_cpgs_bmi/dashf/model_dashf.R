...
setwd("/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv_bmi/dashf/")
print("loading files")
pheno.file="/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv_bmi/dashf/pheno_sva_2.csv"
print(pheno.file)
