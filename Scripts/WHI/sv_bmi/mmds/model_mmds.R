...
setwd("/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv_bmi/mmds/")
print("loading files")
pheno.file="/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv_bmi/mmds/pheno_sva_2.csv"
print(pheno.file)
...
pheno <- pheno[, c(num_covariates, chr_covariates, "Slide","mmds")]
print(head(pheno))
print(names(pheno)) 
pheno <- na.omit(pheno)
print(dim(pheno))
