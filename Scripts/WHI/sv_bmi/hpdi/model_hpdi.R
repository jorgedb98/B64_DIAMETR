...
setwd("/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv_bmi/hpdi/")
print("loading files")
pheno.file="/home/jdominguez1/B64_DIAMETR/Scripts/WHI/sv_bmi/hpdi/pheno_sva_2.csv"
print(pheno.file)
mt_val.file="./mvalues_sd_hpdi.RData"
print(mt_val.file)
...
pheno <- pheno[, c(num_covariates, chr_covariates, "Slide","hpdi")]
print(head(pheno))
print(names(pheno)) 
pheno <- na.omit(pheno)
print(dim(pheno))
