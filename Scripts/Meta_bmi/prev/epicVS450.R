...
mmds_FHS <- get(load("~/B64_DIAMETR/Scripts/FHS/sv_bmi/mmds/bacon.RData"))
mmds_FHS <- mmds_FHS[,c(1,5:7)]

mmds_WHI <- get(load("~/B64_DIAMETR/Scripts/WHI/sv_bmi/mmds/bacon.RData"))
mmds_WHI <- mmds_WHI[,c(1,5:7)]

mmds_450 <- get(load("~/B64_DIAMETR/Scripts/REGICOR/sv_bmi/450k/mmds/model_mmds_bmi.RData"))
...
mmds_epic <- get(load("~/B64_DIAMETR/Scripts/REGICOR/sv_bmi/epic/mmds/bacon.RData"))
...
mmds_airwave <- get(load("/home/jdominguez1/B64_DIAMETR/Scripts/Airwave/results_models_bmi/mmds/bacon.RData"))
...
# DASHF
###################
dashf_FHS <- get(load("~/B64_DIAMETR/Scripts/FHS/sv_bmi/dashf/bacon.RData"))
dashf_FHS <- dashf_FHS[,c(1,5:7)]

dashf_WHI <- get(load("~/B64_DIAMETR/Scripts/WHI/sv_bmi/dashf/bacon.RData"))
dashf_WHI <- dashf_WHI[,c(1,5:7)]

dashf_450 <- get(load("~/B64_DIAMETR/Scripts/REGICOR/sv_bmi/450k/dashf/model_dashf_bmi.RData"))
...
dashf_epic <- get(load("~/B64_DIAMETR/Scripts/REGICOR/sv_bmi/epic/dashf/bacon.RData"))
...
dashf_airwave <- get(load("/home/jdominguez1/B64_DIAMETR/Scripts/Airwave/results_models_bmi/dashf/bacon.RData"))
...
# HPDI
###################
hpdi_FHS <- get(load("~/B64_DIAMETR/Scripts/FHS/sv_bmi/hpdi/bacon.RData"))
hpdi_FHS <- hpdi_FHS[,c(1,5:7)]

hpdi_WHI <- get(load("~/B64_DIAMETR/Scripts/WHI/sv_bmi/hpdi/bacon.RData"))
hpdi_WHI <- hpdi_WHI[,c(1,5:7)]

hpdi_450 <- get(load("~/B64_DIAMETR/Scripts/REGICOR/sv_bmi/450k/hpdi/model_hpdi_bmi.RData"))
...
hpdi_epic <- get(load("~/B64_DIAMETR/Scripts/REGICOR/sv_bmi/epic/hpdi/bacon.RData"))
...
hpdi_airwave <- get(load("/home/jdominguez1/B64_DIAMETR/Scripts/Airwave/results_models_bmi/hpdi/bacon.RData"))
...
save(hpdi_whole, file="~/B64_DIAMETR/Scripts/Meta_bmi/hpdi/model_whole.RData")
save(mmds_whole, file="~/B64_DIAMETR/Scripts/Meta_bmi/mmds/model_whole.RData")
save(dashf_whole, file="~/B64_DIAMETR/Scripts/Meta_bmi/dashf/model_whole.RData")
