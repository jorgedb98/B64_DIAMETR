...
print("Loading files")
setwd("~/B64_DIAMETR/Scripts/Meta_bmi/mmds/")
...
# Coeff<-as.data.frame(modelo[,c("cpg","Coefficient FHS", "Coefficient WHI", "Coefficient REG450", "Coefficient REGepic")])
# SE<- as.data.frame(modelo[,c("cpg","SE FHS", "SE WHI", "SE REG450", "SE REGepic")])
# PVal <-as.data.frame(modelo[,c("cpg","Pvalue FHS", "Pvalue WHI", "Pvalue REG450", "Pvalue REGepic")])
# QVal<-as.data.frame(modelo[,c("cpg","Q FHS", "Q WHI", "Q REG450", "Q REGepic")])
