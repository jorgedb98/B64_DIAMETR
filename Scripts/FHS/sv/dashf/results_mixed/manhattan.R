...
res1 = get(load("/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv/dashf/results_mixed/model_2sva_dashf.RData"))
...
p <- ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ...
  xlab("Chromosome") +
  labs(title = "Manhattan Plot FHS dashf") +
  theme(plot.title = element_text(hjust = 0.5, face = "bold"))

 ggsave(plot = p, filename = "/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv/dashf/results_mixed/manhattanplot.png")  
 save(manh1, file="/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv/dashf/results_mixed/model_2sva_noxy_dashf.RData")
