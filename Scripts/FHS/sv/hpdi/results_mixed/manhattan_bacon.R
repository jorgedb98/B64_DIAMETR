...
res1 = get(load("/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv/hpdi/results_mixed/bacon.RData"))
...
p <- ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ...
  theme( 
   ...
   xlab("Chromosome") +
   labs(title = "Manhattan Plot FHS hpdi", subtitle = "Corrected") +
   theme(plot.title = element_text(hjust = 0.5, face = "bold"), plot.subtitle = element_text(hjust = 0.5, face = "italic"))

 ggsave(plot = p, filename = "/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv/hpdi/results_mixed/manhattanplot_bacon.png")  
 save(manh1, file="/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv/hpdi/results_mixed/bacon_noxy.RData")
