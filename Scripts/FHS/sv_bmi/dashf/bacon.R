...
# sigma.0 
# 1.037314
save(lambda, file="/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv_bmi/dashf/lambda_bacon.RData")

png("/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv_bmi/dashf/qqplot_bacon.png")
plot(bc, type="qq")
###Para añadir la lambda
# text(4, 1, paste0("lambda = ", round(inflation(bc), 3)))
dev.off()

png("/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv_bmi/dashf/hist_bacon.png")
plot(bc, type="hist")
dev.off()
...
save(mod, file="/home/jdominguez1/B64_DIAMETR/Scripts/FHS/sv_bmi/dashf/bacon.RData")
