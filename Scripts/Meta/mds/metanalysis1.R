...
REGICOR <- read.table("/projects/regicor/METIAM/EPIC/EWAS/discovery/mvals_z_4sd/2svas/Model_celltype_svas/model1_2sva.csv", header=T, stringsAsFactors = F, sep=";")
REGICOR <- Regicor[order(Regicor[,1]),]

FHS <- read.table("/projects/regicor/METIAM/EPIC/EWAS_fhs/discov_fhs/mvals_z_4sd/2svas/incid_chd/model_celltype_svas/n2540/model1_2sva.csv", header=T, stringsAsFactors = F, sep=";")
...
write.table(resmeta, file="/projects/regicor/METIAM/EPIC/EWAS_meta/mvals_z_4sd/2svas/incid_chd/n2540/model1.csv", 
            col.names=T, 
            row.names=F, 
            quote=T, 
            sep=";")
...
write.table(res, file="/projects/regicor/METIAM/EPIC/EWAS_meta/mvals_z_4sd/2svas/incid_chd/n2540/model1_noxy.csv", 
            col.names=T, 
            row.names=F, 
            quote=T, 
            sep=";")
