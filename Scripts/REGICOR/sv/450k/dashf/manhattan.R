...
res1 = get(load("/home/jdominguez1/B64_DIAMETR/Scripts/REGICOR/sv/450k/dashf/model_2sva_dashf.RData"))
...
p <- ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ...
  xlab("Chromosome") +
  labs(title = "Manhattan Plot REGICOR 450k dashf") +
  theme(plot.title = element_text(hjust = 0.5, face = "bold"))

 ggsave(plot = p, filename = "~/B64_DIAMETR/Scripts/REGICOR/sv/450k/dashf/manhattanplot.png")  
 save(manh1, file="~/B64_DIAMETR/Scripts/REGICOR/sv/450k/dashf/model_2sva_noxy_dashf.RData")
