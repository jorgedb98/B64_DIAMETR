...
res1 = get(load("/home/jdominguez1/B64_DIAMETR/Scripts/REGICOR/sv/epic/mmds/model_7sva_mmds.RData"))
...
p <- ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ...
  xlab("Chromosome") +
  labs(title = "Manhattan Plot REGICOR epic mmds") +
  theme(plot.title = element_text(hjust = 0.5, face = "bold"))

 ggsave(plot = p, filename = "~/B64_DIAMETR/Scripts/REGICOR/sv/epic/mmds/manhattanplot.png")  
 save(manh1, file="~/B64_DIAMETR/Scripts/REGICOR/sv/epic/mmds/model_7sva_noxy_mmds.RData")
