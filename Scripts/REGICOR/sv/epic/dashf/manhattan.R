...
res1 = get(load("/home/jdominguez1/B64_DIAMETR/Scripts/REGICOR/sv/epic/dashf/model_3sva_dashf.RData"))
...
p <- ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ...
  xlab("Chromosome") +
  labs(title = "Manhattan Plot REGICOR epic dashf") +
  theme(plot.title = element_text(hjust = 0.5, face = "bold"))

 ggsave(plot = p, filename = "~/B64_DIAMETR/Scripts/REGICOR/sv/epic/dashf/manhattanplot.png")  
 save(manh1, file="~/B64_DIAMETR/Scripts/REGICOR/sv/epic/dashf/model_3sva_noxy_dashf.RData")
