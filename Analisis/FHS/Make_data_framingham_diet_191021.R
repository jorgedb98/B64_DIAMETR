...
###################
### We have to download again the FFQ dataset from dbgap because some variables are missing
################### 
...
# We load the phenotype dataset of RCortes
...
# Keep phenotypic variables that are NOT food, because we imported the new version of the food
pheno <- c(names(pheno_fhs)[1:54])
pheno_fhs<-pheno_fhs[,pheno]
