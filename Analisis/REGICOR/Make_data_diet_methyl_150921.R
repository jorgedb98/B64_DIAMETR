...
# Dataset with a subset of participants with DNA methylation at follow-up (A72)
# N=854
metilid<-read_sav("U:/Estudis/B64_DIAMETR/Dades/TELEFORM/lectura_datos/20210507_Camille/dades_id_metil_regicor.sav")
# keep only the participant ID ("parti") for the merge
metilid <- metilid[c(2)]

# merge
metildiet<-merge(metilid,fusion,by="parti",all.x=TRUE,sort=FALSE)

############################################################################
##             SAVE THE DATASET           ## 
############################################################################

# save(metildiet,file="U:/Estudis/B64_DIAMETR/Dades/phenotype_regicor_b18_b37.Rdata")
# N=854
...
#                          0           1           p      test
# n                        422         432                    
# mds_cereal_bf = 1 (%)  198 (50.1)  194 (50.1)  1.000      
# mds_fish_bf = 1 (%)    199 (50.4)  194 (50.1)  1.000      
# mds_meat_bf = 1 (%)    197 (49.9)  193 (49.9)  1.000      
# mds_veg_bf = 1 (%)     198 (50.1)  194 (50.1)  1.000      
# mds_fruit_bf = 1 (%)   198 (50.1)  194 (50.1)  1.000      
# mds_dairy_bf = 1 (%)   197 (49.9)  193 (49.9)  1.000      
# mds_legume_bf = 1 (%)  200 (50.6)  194 (50.1)  0.945      
# mds_mufasfa_bf = 1 (%) 198 (50.1)  194 (50.1)  1.000      
# mds_alcohol_bf = 1 (%) 195 (49.4)  91 (23.5)   <0.001     
# mds_b (mean (SD))      4.51 (1.79) 4.24 (1.70) 0.034  

## What tab outputs is a table representing the proportion of samples, strtified
## by sex, that meets value 1 for score in each of the 9 items. Substrating
## from the total (n) allows to get those values for scoring 0.

# modified by Jorge, just trying. #

# tab2 <- CreateTableOne(vars = vars03, strata = "parti", data = metildiet)
# try2 <- print(tab2, noSpaces= TRUE)
...
############################################################################
# Varibles of interest for final scoring

# metildiet$mds_b <- First scoring method
# metildiet$mmds_b <- Second scoring function
# metildiet$rmed_b <- Third scoring function
# metildiet$hdi_b <- Fourth scoring function
# metildiet$dashf_b <- Fifth scoring function
# metildiet$hpdi_b <- Sixth scoring Function

save(metildiet, file = "U:/Estudis/B64_DIAMETR/Dades/regicor_diet_with_scores.RData")
